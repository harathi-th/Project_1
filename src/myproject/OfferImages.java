...
WebDriver driver;
	...
	@Test
	public void AddingToCartFromOffers() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//strong[normalize-space()='Hot pantsHot deals']")).click();
		driver.findElement(By.xpath("//img[@alt='Portia Capri']")).click();
